...
from models import DifficultyLevel, Game, GuessStatus, Round
...
class TestGameUpdateSchema:
    """
    The GameUpdateSchema class in schemas.py
    """

    @pytest.fixture
    def game_update_schema(self):
        return GameUpdateSchema()

    def test_guess(self, game_update_schema):
        """
        has a guess field of type Int.
        """
        assert isinstance(game_update_schema.fields["guess"], fields.Int)
        assert game_update_schema.fields["guess"].required is True
